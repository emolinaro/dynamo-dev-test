...
I did not find a first-class, user-facing Dynamo `v1.0.1` guide for text-to-audio generation in the official docs used for this scaffold. The public docs clearly cover text-to-text, text-to-image, text-to-video, image-to-video, FastVideo, TensorRT-LLM video diffusion, and SGLang diffusion, but not a stable text-to-audio quickstart.
